...
type LoginStep = 'camera' | 'scanning' | 'success';
  ...
  return (
    <div className="min-h-screen bg-foreground flex flex-col items-center justify-center px-4 relative">
      ...
      <div className="text-center mb-8">
        <h2 className="text-heading text-primary-foreground font-bold">Validação Facial</h2>
        <p className="text-primary-foreground/60 mt-1">Posicione seu rosto no centro</p>
      </div>
